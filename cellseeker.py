...
def cropEM(parent):
		...
		outpath=savepath+cellName+"_EM.tiff"
    	        mptiffstring="/media/feynman/3TBBackup/Scripts/CellSeeker/newstack -siz " + str(xsize) + "," + str(ysize) +" -off " + str(xoff) + "," + str(yoff) + " -ori -sec " + str(zstart) + "-" + str(zend) + " " + parent.emdir.get() + " -fo TIF " + outpath
		subprocess.call(mptiffstring,shell=True)
